...
test.hiFn2:
    ...
    mov ebp, esp; 设置基指针
    sub esp, 20; 调整栈指针
    mov DWORD[ebp+12], 9; 设置函数参数
    mov QWORD[ebp+8], 78; 设置函数参数
    call test.hiMyLang2; 调用函数
    mov  DWORD[ebp-4], 1; 设置变量
    mov EAX, 123; 保存表达式左边的值
    imul EAX, DWORD[ebp-4]; 计算表达式的值
    mov  DWORD[ebp-8], EAX; 设置变量
    cmp EAX, EBX; 比较表达式的值
...
test.main0:
    ...
    mov ebp, esp; 设置基指针
    sub esp, 16; 调整栈指针
    mov QWORD[ebp+16], 1; 设置函数参数
    mov QWORD[ebp+8], 100; 设置函数参数
